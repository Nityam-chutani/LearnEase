...
export default function CarouselSlide({ details }) {
  return (
    <div className="md:w-auto w-full flex dark:bg-gray-700 md:flex-row flex-col gap-7 mx-auto md:h-[350px] h-[550px] overflow-hidden">
      <img
        src={details.image}
      ...
      <div className="flex flex-col md:gap-10 gap-6">
        ...
        <p className="flex flex-col gap-0">
          ...
          />
          <span className="text-gray-500 md:text-2xl text-lg dark:text-white font-lato font-[500] px-10">
            {details.description}
          </span>
          <BsQuote
            size={50}
